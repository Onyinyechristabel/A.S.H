<template>
  <section class="about">
    <div class="about_content">
      ...
      <h3 class="about_right">
        A.S.H is a creator-led collective that collaborates with leading game
        studios to bring video game worlds to life through video production,
        immersive experiences, media, and custom collectibles.
      </h3>
    </div>
